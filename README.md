...
- Intro to Compute
  ...
  - Google: [Compute Engine (website, no sign-up needed)](https://cloud.google.com/compute)
- Intro to Storage (comparison between Azure, AWS, Google)
  - Azure: [Explore Azure Storage services (MS Learn, no sign-up needed)](https://docs.microsoft.com/en-us/learn/modules/azure-storage-fundamentals/)
  ...
  - Google: [File storage, collaboration & docs (Google Workspace Learning Center, no sign-up needed)](https://support.google.com/a/users/answer/10005650?visit_id=637626467996669028-4241468714&hl=en&rd=1)
